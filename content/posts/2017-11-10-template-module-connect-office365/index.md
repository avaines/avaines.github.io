...
This script simply puts some belts and braces around importing the Office 365 modules and connecting to the service(s) inline with the [Powershell Template](/posts/2017-05-28-powershell-framework)

## Setup

* Create a project using the [Powershell Template](/posts/2017-05-28-powershell-framework/)
...
![flowchart](psh-connecto365_1.png)
