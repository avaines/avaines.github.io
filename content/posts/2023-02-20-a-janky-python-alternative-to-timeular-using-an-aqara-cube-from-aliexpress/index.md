...
code_url: "https://github.com/avaines/timesheet-cube"
tags:
  - python
  - automation
  - hardware
...
Once a change to the cube face is detected it makes a calendar change via the [O365](https://github.com/O365/python-o365) Python library which made things a whole lot easier than I expected it to be. The end result through did exactly what I wanted (which has to be a first):

![outlook calendar with calendar segments](time-cube-calendar.png)
...
* Create an Office365 Enterprise app with the calendar permissions following [https://github.com/O365/python-o365#calendar](https://github.com/O365/python-o365#calendar)
...
![Home Assistant helper config](https://raw.githubusercontent.com/avaines/timesheet-cube/main/misc/homeassistant-helper.png)
